# Claude CLI Bootstrap

This file makes Claude CLI load the reusable `agent-dev-system` for this project.
...
- Better context window management for large projects
- Improved file structure understanding
