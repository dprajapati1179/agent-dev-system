...
This file makes Kilo CLI load the reusable `agent-dev-system` for this project.
...
## Kilo-specific optimizations

- Fast command execution and terminal integration
- Efficient file system operations
- Quick project scanning and analysis
- Streamlined workflow for rapid development cycles
