# Universal CLI Bootstrap

This file makes any AI CLI tool load the reusable `agent-dev-system` for this project.
...
This bootstrap file works with:
- **Gemini CLI** - Use GEMINI.md for Gemini-specific optimizations
- **Claude CLI** - Use CLAUDE.md for Claude-specific optimizations  
- **Kilo CLI** - Use KILO.md for Kilo-specific optimizations
- **Windsurf CLI** - Use this universal file
- **Cursor CLI** - Use this universal file
- **Aider CLI** - Use this universal file
- **Antigravity CLI** - Use this universal file
- **Any other AI CLI** - Use this universal file

## Usage instructions

For CLI-specific optimizations, reference the appropriate file:
```bash
# For Gemini
...
# For any other CLI
[ai-cli] "please read @./UNIVERSAL.md and follow its instructions"
```
